...
ZH = FCCComponent(
    'heppy/ee_to_ZH_to_nunuww/CLD/Jun13/ee_to_ZH_Oct30',
    xSection=2.e-10,
    nGenEvents=5000*100.,
    uncertainty=1
)
...
ZZ = FCCComponent(
    'heppy/ee_to_ZH_to_nunuww/CLD/Jun13/ee_to_ZZ_Sep12_A_2',
    xSection=1.35e-9,
...
WW = FCCComponent(
    'heppy/ee_to_ZH_to_nunuww/CLD/Jun13/ee_to_WW_Dec6_large',
    xSection=1.64e-8,  
